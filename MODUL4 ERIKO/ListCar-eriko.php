                        ...
                        <div class="col">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="Profil-eriko.php">Profil</a></li>
                                    <li><a class="dropdown-item" href="LoginHome_Aebil.php">LogOut</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="Detail-eriko.php?id_mobil=<?php echo $select['id_mobil']?>"
