...
<head>
  ...
  <title>Detail Car | eriko_1202200209</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link" href="../pages/ListCar-eriko.php">MyCar</a>
          </div>
        </div>
        <div class="d-flex">
          <a href="../pages/Add-eriko.php">
          ...
          <div class="dropdown ms-4">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item" href="../pages/Profile-eriko.php">Profile</a></li>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-eriko.php?id=" . $obtainData["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
