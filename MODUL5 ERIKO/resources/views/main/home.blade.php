  ...
  <section id="home">
    <div class="container">
      <div class="d-flex gap-5 rap justify-content-center align-items-center">
        <div>
          <h1>Selamat Datang Di<br /> Show Room eriko</h1>
          <p class="mt-3">Showroom terbaik didunia</p>
          <a href="/product" class="button btn-primary">MyCar</a>
          <div class="d-flex align-items-center gap-5 mt-5">
            <img src="/asset/images/logo-ead.png" alt="logoead" style="width:100px;">
            <p style="margin-top: 20px; font-size:15px;">eriko_1202200209</p>
          </div>
        </div>
...
<section id="home">
    <div class="container">
      <div class="d-flex gap-5 rap justify-content-center align-items-center">
        <div>
          <h1>Selamat Datang Di<br /> Show Room eriko</h1>
          <p class="mt-3">Showroom terbaik di dunia</p>
          <div class="d-flex align-items-center gap-5 mt-5">
